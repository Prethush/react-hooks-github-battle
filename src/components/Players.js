function Players(props) {
    ...
    return (
        <>
        {/* Enter github username to get different users github data */}
        {/* form1 to enter user1 github username */}
            <form onSubmit={(e) => props.handleSubmit(e)} data-id="inputText1" className={props.hideForm1 && !props.closeUser1Data ? "hidden": "flex-100 2xl:flex-50 my-4"}>
                    ...
                    <fieldset className="my-2 flex justify-center">
                        <input type="text" placeholder="github username" id="p-1" className={"border-2 border-gray-200 py-4 w-52 sm:w-64 md:w-72 xl:w-80 2xl:w-96 px-2" + (props.darkMode ? " bg-gray-600 " :"")} data-id="inputText1" value={inputText1} onChange={(e) => props.handleChange(e)} onKeyDown={(e) => props.handleKeyPress(e)}/>
            ...
            <div className={props.closeUser1Data && !props.hideForm1 ? "hidden": "flex flex-100 2xl:flex-50 justify-between  mr-20 p-2 rounded-md bg-gray-400 my-3"} >
            ...
            {/*form12 to enter user2 github username  */}
            <form onSubmit={(e) => props.handleSubmit(e)} data-id="inputText2" className={props.hideForm2 && !props.closeUser2Data ? "hidden": "flex-100 2xl:flex-50 my-4"}>
                    ...
                    <fieldset className="my-2 flex justify-center">
                        <input type="text" placeholder="github username" id="p-2" className={"border-2 border-gray-200 py-4 w-52 sm:w-64 md:w-72 xl:w-80 2xl:w-96 px-2" + (props.darkMode ? " bg-gray-600 " :"")} value={inputText2} data-id="inputText2" onChange={(e) => props.handleChange(e)} onKeyDown={(e) => props.handleKeyPress(e)}/>
                        <input type="submit" value="submit" className="py-4 ml-4 px-8 cursor-pointer bg-blue-500 rounded-md text-white font-bold"/>
                    </fieldset>
            </form>

             {/* display user2 details */}
